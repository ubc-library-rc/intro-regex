...
| Hello World! | `[^aeiou\s]`      | Square brackets with a caret (or circumflex). Creates a negated character class. Matches a single character that is not contained <br>between the square brackets.                                                              | 8       | 'H', 'l', 'l', 'W', 'r', 'l', 'd', '!'                     |
